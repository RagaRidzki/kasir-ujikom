...
@section('content')
<div class="p-6">
    <x-breadcrumb title="Data User" :paths="[
        ['name' => 'Home', 'url' => ''],
        ['name' => 'Data User', 'url' => ''],
    ]" />
            ...
            <table class="w-full min-w-[540px] border-collapse">
                ...
                <tbody>
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="py-3 px-5 border-b border-gray-300">Nama User</td>
                        <td class="py-3 px-5 border-b border-gray-300">
                            Email User
                        </td>
                        <td class="py-3 px-5 border-b border-gray-300">Role User</td>
                        <td class="py-3 px-5 border-b border-gray-300">
                            <ul class="flex items-center space-x-3">
                                <li>
                                    <a href="/product/edit/id" class="text-gray-500 hover:text-gray-700">
                                        <i class="ri-edit-line text-lg"></i>
                                    </a>
                                </li>
                                <li>
                                    <form action="/product/id" method="POST" id="delete-form-id">
